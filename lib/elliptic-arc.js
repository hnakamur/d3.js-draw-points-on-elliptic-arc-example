...
//EllipticArc.prototype.getTangentToXYAxesTs = function() {
//  return this.getTangentToXYAxesAngles().map(function(angle) {
//    return this.getTAtAngle(angle);
//  }, this);
//};

EllipticArc.prototype.getTangentToXYAxesAngles = function() {
  // deriv(theta)
